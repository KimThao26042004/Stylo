...
ALTER TABLE [dbo].[NhanVien]
ALTER COLUMN [ngaySinh] [nvarchar](10) NULL;

ALTER TABLE [dbo].[NhanVien]
ALTER COLUMN [created_at] [nvarchar](10) NULL;

ALTER TABLE [dbo].[NhanVien]
ALTER COLUMN [updated_at] [nvarchar](10) NULL;

DELETE FROM dbo.DonHang_ChiTiet;
DELETE FROM dbo.VanDon;
DELETE FROM dbo.DonHang;
DELETE FROM dbo.DanhGia;

DELETE FROM dbo.AnhSanPham;
DELETE FROM dbo.User_Product_Interaction;
DELETE FROM dbo.TonKho;

DELETE FROM dbo.SanPham_BienThe;
DELETE FROM dbo.SanPham;


DBCC CHECKIDENT ('dbo.SanPham', RESEED, 0);
DBCC CHECKIDENT ('dbo.SanPham_BienThe', RESEED, 0);
...
FROM Dedup d
OUTER APPLY (
    SELECT TOP 1 DanhMucID
    FROM DanhMuc
    WHERE Ten = d.sub_category
    ORDER BY DanhMucID
) dm1
OUTER APPLY (
    SELECT TOP 1 ThuongHieuID
    FROM ThuongHieu
    WHERE Ten = d.brand
    ORDER BY ThuongHieuID
) th1
WHERE d.rn = 1
  AND NOT EXISTS (
      SELECT 1
      FROM SanPham p
      WHERE p.SanPhamID = d.product_id
  );

SET IDENTITY_INSERT dbo.SanPham OFF;


UPDATE DonHang SET NgayDat = '2025-01-15' WHERE DonHangID BETWEEN 1 AND 3000;
UPDATE DonHang SET NgayDat = '2025-02-15' WHERE DonHangID BETWEEN 3001 AND 6000;
UPDATE DonHang SET NgayDat = '2025-03-15' WHERE DonHangID BETWEEN 6001 AND 8000;
UPDATE DonHang SET NgayDat = '2025-04-15' WHERE DonHangID BETWEEN 8001 AND 1100;
UPDATE DonHang SET NgayDat = '2025-05-15' WHERE DonHangID BETWEEN 11101 AND 13000;
UPDATE DonHang SET NgayDat = '2025-06-15' WHERE DonHangID BETWEEN 13001 AND 19000;
UPDATE DonHang SET NgayDat = '2025-07-15' WHERE DonHangID BETWEEN 19001 AND 26000;
UPDATE DonHang SET NgayDat = '2025-08-15' WHERE DonHangID BETWEEN 26001 AND 30000;
UPDATE DonHang SET NgayDat = '2025-09-15' WHERE DonHangID BETWEEN 30001 AND 33000;
UPDATE DonHang SET NgayDat = '2025-10-15' WHERE DonHangID BETWEEN 33001 AND 37000;
UPDATE DonHang SET NgayDat = '2025-11-15' WHERE DonHangID BETWEEN 37001 AND 41000;
UPDATE DonHang SET NgayDat = '2025-12-15' WHERE DonHangID BETWEEN 41001 AND 47889;

--số đơn cho các tháng trong năm
SELECT 
    YEAR(NgayDat) AS Nam,
